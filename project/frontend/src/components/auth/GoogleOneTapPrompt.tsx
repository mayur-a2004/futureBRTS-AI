...
export const GoogleOneTapPrompt: React.FC = () => {
  ...
  return (
    <>
      {/* 🚀 Sleek High-Conversion Floating Banner (Top-Right Google OAuth Panel) */}
      {showFallbackBanner && (
        <div className="fixed top-4 right-4 z-[9999] max-w-sm w-full p-4 rounded-2xl bg-gradient-to-r from-zinc-950 via-indigo-950/90 to-purple-950/90 border border-indigo-500/40 shadow-2xl backdrop-blur-md animate-in slide-in-from-top duration-300">
          <button
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1 space-y-1 pr-4">
              ...
              <p className="text-[11px] text-gray-300 leading-tight">
                Get 5,000 free credits instantly to access AI Tutor, Exam Solver & Roadmaps!
              </p>
            </div>
          </div>
          ...
          <div className="mt-3 flex gap-2">
            ...
            >
              <span>Instant 1-Click Signup</span>
              <ArrowRight size={12} />
            </button>
            <button
