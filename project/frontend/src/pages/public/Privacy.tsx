    ...
    return (
        <div className="py-32 px-6 max-w-7xl mx-auto space-y-60 text-white font-sans overflow-x-hidden relative">
            ...
            <section className="relative flex flex-col items-center text-center space-y-16">
                ...
                >
                    ...
                    <div className="space-y-6 relative z-10">
                        ...
                        <h1 className="text-4xl md:text-6xl font-black tracking-tighter leading-[0.8] mb-8 uppercase italic">
                            DATA <br />
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 via-cyan-500 to-indigo-400 animate-gradient-x drop-shadow-[0_0_20px_rgba(16,185,129,0.3)]">
                                SHIELD.
                            </span>
                        </h1>
                    </div>
                ...
                <p className="text-base md:text-lg text-gray-500 font-medium leading-relaxed max-w-4xl mx-auto border-y border-white/5 py-12 px-10 italic">
            ...
            <section className="bg-white/[0.01] border border-white/5 rounded-[4rem] p-12 md:p-32 relative overflow-hidden group">
                ...
                <div className="grid lg:grid-cols-2 gap-32 items-center relative z-10">
                    ...
                    <div className="relative">
                        <div className="p-1 rounded-[3rem] bg-gradient-to-br from-emerald-500/20 via-white/5 to-cyan-500/20 shadow-2xl">
                            <div className="bg-[#050505] rounded-[2.9rem] p-16 flex flex-col items-center justify-center text-center space-y-10 border border-white/10">
                                <motion.div
                                    ...
                                    className="relative"
                                >
                                    <ShieldCheck size={120} className="text-emerald-500/30" />
                                    <div className="absolute inset-0 flex items-center justify-center">
                                        <Key size={30} className="text-white animate-pulse" />
                                    </div>
                                </motion.div>
                                <div className="space-y-2">
                                    <h3 className="text-2xl font-black italic tracking-tighter uppercase">ZERO_LEAK_HISTORY</h3>
